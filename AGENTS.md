...
- 每次代码或文档改动都要同步更新版本号，小的迭代更新最后一位(比如1.2.13这里的13)，push前更新第二位，有重大更新时才更新第一位，并保持 `README.md`、`manifest.json`、`package.json`、`src/shared.js` 和 `tests/shared.test.mjs` 中的版本一致。
